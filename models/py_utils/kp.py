...
from models.py_utils import global_local
...
class kp(nn.Module):
    def __init__(self,
        ...
        self.inplanes = res_dims

        self.detail = global_local.DetailBranch()
        self.segment = global_local.SegmentBranch()
        self.bga = global_local.BGALayer()
    ...
    def _train(self, *xs, **kwargs):
        ...
        p_1 = self.detail(images)  # 16 32
        p_2 = self.segment(images)  # 4 8
        p = self.bga(p_1, p_2)  # 16 32
